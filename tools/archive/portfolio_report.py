...
def generate_portfolio_report(
    ...
    if df is None or df.empty:
        ...
        market = MarketData()
        df = market.get_current_snapshot()
...
def _build_portfolio_html(
    ...
    <body>
        ...
        <div class="slide">
            ...
            <p class="slide-subtitle">Project duration from queue entry to present</p>
        ...
        <div class="slide">
            ...
            <p class="slide-subtitle">Developer concentration and market share</p>
            ...
            <div class="metric-box">
                ...
                <div class="metric-note">HHI: &lt;1500 = Competitive | 1500-2500 = Moderate | &gt;2500 = Concentrated</div>
            </div>
        ...
        <div class="slide">
            ...
            <p class="slide-subtitle">Leading developers by pipeline capacity</p>
        ...
        <div class="slide">
            ...
            <div style="display: flex; gap: 25px;">
                ...
                <div style="flex: 1;">
                    ...
                    <ul class="source-list">
                        <li>Queue data reflects publicly available information</li>
                        <li>Completion rates are historical averages</li>
                        <li>Cost benchmarks are broad ranges</li>
                        <li>Developer names not standardized across ISOs</li>
                    </ul>

                    <h3>ISOs Covered</h3>
                    <ul class="source-list">
                        <li>NYISO, CAISO, PJM, ERCOT</li>
                        <li>MISO, SPP, ISO-NE</li>
                    </ul>
                </div>
            </div>
